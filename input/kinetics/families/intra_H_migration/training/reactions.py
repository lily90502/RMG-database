...
entry(
    ...
    kinetics = Arrhenius(
        ...
        Tmin = (300, 'K'),
        Tmax = (1500, 'K'),
        comment = "Sumathy B3LYP/CCPVDZ calculations (hindered rotor potential barrier calculations at B3LYP/6-31G(d'))\n\nConverted to training reaction from rate rule: R2H_S;C_rad_out_H/NonDeC;Cs_H_out_2H",
    ),
    rank = 5,
...
entry(
    ...
    kinetics = Arrhenius(
        ...
        Tmin = (300, 'K'),
        Tmax = (1500, 'K'),
        comment = 'CH3OO to CH2OOH, degeneracy=3, rate for per hydrogen, J. Phys. Chem. A.,Vol.114,No.18,2010\n\nConverted to training reaction from rate rule: R3H_SS_O;O_rad_out;Cs_H_out_2H',
    ),
    rank = 5,
...
entry(
    ...
    kinetics = Arrhenius(
        ...
        Tmin = (300, 'K'),
        Tmax = (1500, 'K'),
        comment = 'CH3CH2OO to CH3CHOOH, degeneracy=2, rate for per hydrogen, J. Phys. Chem. A.,Vol.114,No.18,2010\n\nConverted to training reaction from rate rule: R3H_SS_O;O_rad_out;Cs_H_out_H/NonDeC',
    ),
    rank = 5,
    shortDesc = u"""Sumathy CBS-Q calculations""",
)
...
entry(
    ...
    kinetics = Arrhenius(
        ...
        Tmin = (300, 'K'),
        Tmax = (1500, 'K'),
        comment = 'CH3CH2CH2OO to CH3CH2CHOOH, degeneracy=2, rate for per hydrogen, J. Phys. Chem. A.,Vol.114,No.18,2010\n\nConverted to training reaction from rate rule: R3H_SS_O;O_rad_out;Cs_H_out_H/(NonDeC/Cs)',
    ),
    rank = 5,
    shortDesc = u"""Sumathy CBS-Q calculations""",
)
...
entry(
    ...
    kinetics = Arrhenius(
        ...
        Tmin = (300, 'K'),
        Tmax = (1500, 'K'),
        comment = '(CH3)2CHCH2OO to (CH3)2CHCHOOH, degeneracy=2, rate for per hydrogen, J. Phys. Chem. A.,Vol.114,No.18,2010\n\nConverted to training reaction from rate rule: R3H_SS_O;O_rad_out;Cs_H_out_H/(NonDeC/Cs/Cs)',
    ),
    rank = 5,
    shortDesc = u"""Sumathy CBS-Q calculations""",
)
...
entry(
    ...
    kinetics = Arrhenius(
        ...
        Tmin = (300, 'K'),
        Tmax = (1500, 'K'),
        comment = '(CH3)3CCH2OO to (CH3)3CCHOOH, degeneracy=2, rate for per hydrogen, J. Phys. Chem. A.,Vol.114,No.18,2010\n\nConverted to training reaction from rate rule: R3H_SS_O;O_rad_out;Cs_H_out_H/(NonDeC/Cs/Cs/Cs)',
    ),
    rank = 5,
    shortDesc = u"""Sumathy CBS-Q calculations""",
)
...
entry(
    ...
    kinetics = Arrhenius(
        ...
        Tmin = (300, 'K'),
        Tmax = (1500, 'K'),
        comment = '(CH3)2CHOO to (CH3)2COOH, degeneracy=1, rate for per hydrogen, J. Phys. Chem. A.,Vol.114,No.18,2010\n\nConverted to training reaction from rate rule: R3H_SS_O;O_rad_out;Cs_H_out_Cs2',
    ),
    rank = 5,
    shortDesc = u"""Sumathy CBS-Q calculations""",
)
...
entry(
    ...
    kinetics = Arrhenius(
        ...
        Tmin = (300, 'K'),
        Tmax = (1500, 'K'),
        comment = 'CH3CH2OO to CH2CH2OOH, degeneracy=3, rate for per hydrogen, J. Phys. Chem. A.,Vol.114,No.18,2010\n\nConverted to training reaction from rate rule: R4H_SSS_OCs;O_rad_out;Cs_H_out_2H',
    ),
    rank = 5,
    shortDesc = u"""Sumathy CBS-Q calculations""",
)
...
entry(
    ...
    kinetics = Arrhenius(
        ...
        Tmin = (300, 'K'),
        Tmax = (1500, 'K'),
        comment = '(CH3)2CHOO to CH3(CH2)CHOOH, degeneracy=6, rate for per hydrogen, J. Phys. Chem. A.,Vol.114,No.18,2010\n\nConverted to training reaction from rate rule: R4H_SSS_O(Cs)Cs;O_rad_out;Cs_H_out_2H',
    ),
    rank = 5,
    shortDesc = u"""Sumathy CBS-Q calculations""",
)
...
entry(
    ...
    kinetics = Arrhenius(
        ...
        Tmin = (300, 'K'),
        Tmax = (1500, 'K'),
        comment = '(CH3)3COO to (CH3)2(CH2)COOH, degeneracy=9, rate for per hydrogen, J. Phys. Chem. A.,Vol.114,No.18,2010\n\nConverted to training reaction from rate rule: R4H_SSS_O(Cs)CsCs;O_rad_out;Cs_H_out_2H',
    ),
    rank = 5,
    shortDesc = u"""Sumathy CBS-Q calculations""",
)
...
entry(
    ...
    kinetics = Arrhenius(
        ...
        Tmin = (300, 'K'),
        Tmax = (1500, 'K'),
        comment = 'CBS-QB3 and BH&HLYP calculations (Catherina Wijaya & Sumathy Raman). Including treatment of hindered rotor.\n\nConverted to training reaction from rate rule: R5H_SSSS_OCC;O_rad_out;Cs_H_out_2H',
    ),
    rank = 5,
...
entry(
    ...
    kinetics = Arrhenius(
        ...
        Tmin = (300, 'K'),
        Tmax = (1500, 'K'),
        comment = 'Sandeep and Sumathy paper (submitted to JPCA 2009), intra_H_migration of ROO & HOOQOO.\n\nConverted to training reaction from rate rule: R3H_SS_O;O_rad_out;Cs_H_out_H/NonDeO',
    ),
    rank = 6,
...
entry(
    ...
    kinetics = Arrhenius(
        ...
        Tmin = (600, 'K'),
        Tmax = (1500, 'K'),
        comment = 'BMK/6-311G(2d,d,p) TST Eckart, no HR. calculated for cycC5H5-CH2 -> cycC5H4-CH3\n\nConverted to training reaction from rate rule: R2H_S;C_rad_out_2H;Cs_H_out_CdCd',
    ),
    rank = 10,
